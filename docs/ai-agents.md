...
7. Run `veritas repair-prompt` for the concise AI repair queue, patch plan, mutation trend summary, proof commands, and done-when criteria. In GitHub Actions, use `veritas repair-prompt --github-step-summary`.
