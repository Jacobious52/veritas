...
Medium-sized Rust fixture for the evolutionary verification loop.
...
- corpus metadata for promoted regression work
- `.veritas/evolution/rust_suite.json` with multiple selected candidates
